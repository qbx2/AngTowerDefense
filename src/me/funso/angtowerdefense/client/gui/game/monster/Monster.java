...
public abstract class Monster implements Paintable, TimerSettable {
	...
	public Monster() throws IOException, InterruptedException {
		image = new Image[6];
		image[0] = ImageIO.read(getClass().getClassLoader().getResource("img/monster/zergling.png"));
		image[1] = ImageIO.read(getClass().getClassLoader().getResource("img/monster/golem.png"));
		image[2] = ImageIO.read(getClass().getClassLoader().getResource("img/monster/citizen.png"));
		image[3] = ImageIO.read(getClass().getClassLoader().getResource("img/monster/shaco.png"));
		image[4] = ImageIO.read(getClass().getClassLoader().getResource("img/monster/bee.png"));
		image[5] = ImageIO.read(getClass().getClassLoader().getResource("img/monster/boss.png"));
