...
public class LazerTower extends Tower {
    ...
    public LazerTower(int x, int y, int r_x, int r_y) {
        ...
        cost = GameMain.towerInfo[2].cost;
        attack_range = size*GameMain.towerInfo[2].attack_range;
        attack_speed = GameMain.towerInfo[2].attack_speed;
        damage = GameMain.towerInfo[2].damage;
        name = GameMain.towerInfo[2].name;
