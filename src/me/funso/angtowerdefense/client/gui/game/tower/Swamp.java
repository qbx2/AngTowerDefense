...
public class Swamp extends Tower {
    ...
    public Swamp(int x, int y, int r_x, int r_y) {
        ...
        cost = GameMain.towerInfo[3].cost;
        attack_range = size*GameMain.towerInfo[3].attack_range;
        attack_speed = GameMain.towerInfo[3].attack_speed;
        damage = GameMain.towerInfo[3].damage;
        name = GameMain.towerInfo[3].name;
